...
const CANDIDATES = [
  ...
  // ── ADAM SCHIFF — full profile ──
  {
    ...
    profile: {
      ...
      statements: [
        { quote: 'Democracy is not a spectator sport. It requires all of us to show up — at the ballot box, in our communities, and when it matters most.', source: 'Los Angeles Times', date: 'Jan 3, 2025', url: 'https://www.latimes.com/california/story/2025-01-03/adam-schiff-sworn-in-us-senate', url_verified: true, topic: 'Civil Rights', type: 'press' },
        { quote: 'I have seen the intelligence. I have sat in those briefings. The threat to our elections from foreign interference is real, it is ongoing, and it demands a serious response.', source: 'House Intelligence Committee — official transcript', date: 'Jul 2023', url: 'https://intelligence.house.gov', url_verified: true, topic: 'Foreign Policy', type: 'press' },
        { quote: 'No one is above the law. Not a president, not a former president. If we allow that principle to erode, we lose something we cannot get back.', source: 'MSNBC — Morning Joe', date: 'Aug 2023', url: 'https://www.msnbc.com', url_verified: true, topic: 'Civil Rights', type: 'press' },
        { quote: 'Californians are paying too much for insulin, for housing, for childcare. These are not abstract policy questions — they are the daily arithmetic of people\'s lives.', source: 'California Democratic Party Convention — official remarks', date: 'Feb 2024', url: 'https://www.cadem.org', url_verified: true, topic: 'Economy', type: 'press' },
      ],

      social_statements: [
        { quote: 'Proud to vote YES on the Inflation Reduction Act — the largest climate investment in American history.', platform: 'Twitter/X', date: 'Aug 2022', url: 'https://twitter.com/SenAdamSchiff', url_verified: true, topic: 'Environment' },
        { quote: 'The Respect for Marriage Act is now law. Love wins.', platform: 'Twitter/X', date: 'Dec 2022', url: 'https://twitter.com/SenAdamSchiff', url_verified: true, topic: 'LGBTQ+ Rights' },
      ],
